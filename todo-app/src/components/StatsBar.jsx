  ...
  return (
    <div className="mt-5 flex items-center justify-between text-xs text-slate-400">
      ...
      <button
        type="button"
        onClick={onClearAll}
        className="text-[11px] px-2 py-1 rounded-lg border border-slate-700 hover:border-red-500/70 hover:text-red-300 hover:bg-red-500/10 transition-colors duration-150"
      >
        Clear all
      </button>
    </div>
